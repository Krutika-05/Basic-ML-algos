...
class my_GA:
    ...
    def initialize(self):
        ...
        self.generation_len = len(self.generation)
    ...
    def evaluate(self, decision):
        ...
        if decision not in self.evaluated:
            ...
            for fold in range(self.crossval_fold):
                ...
                #seperate conditions for test and train conditions
               ...
               #alternatively done for the weighted averages.
                if type(objs_crossval) == type(None):
                    objs_crossval = objs
                else:
                    objs_crossval += objs

            objs_crossval = objs_crossval
    ...
    def is_better(self, a, b):
        ...
        second = self.evaluate(b)
        #this is to calculate the conditions to check the comparisions
        current = 0
        for counter in range(len(first)):
            if first[counter] > second[counter]:
                current += 1
             #greater than condition for the secong variable.   
            elif first[counter] < second[counter]:
                current -= 1
            else:
                pass
        ...
        if current > 0:
            return 1
        #for the currrent value == 0 , we have to conclude equal comparision and return 0
        elif current == 0:
            return 0
        else:
            return -1
